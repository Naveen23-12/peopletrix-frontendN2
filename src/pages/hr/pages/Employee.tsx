...
const Employee = () => {
  ...
  return (
    <div className="w-full max-w-full min-h-[560px] overflow-hidden">
      {/* Top Search */}
      ...
      {/* <div className="w-full max-w-[786px] bg-[#F8F8FF] rounded-[22px] mb-8 overflow-hidden">
        <div className="w-full min-h-[145px] flex flex-row items-center justify-between gap-3 sm:gap-4 px-4 sm:px-8 lg:px-11 pt-5 sm:pt-0 relative">
          <button
            onClick={() => setShowAddEmployee(true)}
            className="w-full max-w-[257px] h-[57px] bg-[#E8EAF8] rounded-[10px] flex items-center justify-center gap-3 text-[#5863B2] text-[17px] sm:text-[24px] font-normal shrink-0 overflow-visible"
          >
  ...
  >
    <button
      ...
      className="
        ...
        shrink
        overflow-visible
        max-[880px]:max-w-[230px]
        max-[880px]:h-[52px]
        max-[880px]:text-[20px]
        max-[600px]:max-w-[200px]
        max-[600px]:h-[48px]
        max-[600px]:text-[17px]
        max-[480px]:max-w-[180px]
        max-[480px]:h-[44px]
        max-[480px]:text-[15px]
      "
    >
      <Plus
        size={28}
        strokeWidth={2}
        className="shrink-0 max-[600px]:w-5 max-[600px]:h-5 "
      />
      Add Employee
    </button>
              ...
              {filteredEmployees.length === 0 ? (
                ...
                filteredEmployees.map((employee) => (
                  ...
                  >
                    ...
                    <td className="px-3 xl:px-8 text-[14px] xl:text-[16px] text-[#5863B2] truncate">
                      <div className="flex items-center justify-center gap-3">
                        ...
                        ></span>
                        <span className="truncate">{employee.status}</span>
                      </div>
                    </td>
        ...
        {filteredEmployees.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
            {filteredEmployees.map((employee) => (
              <div
                key={employee.id}
                className="w-full min-w-0 bg-[#F8F8FF] rounded-xl p-4 shadow-[0px_4px_6px_rgba(88,99,178,0.18)] overflow-hidden"
              >
                ...
                <div className="space-y-2 text-sm text-[#5863B2]">
                  <div className="flex justify-between gap-3 min-w-0">
                    ...
                    <span className="flex items-center gap-2 min-w-0 text-right">
                      ...
                      ></span>
                      <span className="break-words">{employee.status}</span>
                    </span>
                  </div>
