...
import { validateAttendancePolicy } from "../../../../utils/validations";
...
const SetAttendance = ({ onClose }: SetAttendanceProps) => {
  ...
  const handleSubmit = async () => {
    const validationError = validateAttendancePolicy({
      workingHours,
      workingDays,
      startTime,
      endTime,
  ...
  return (
    <div className="w-full flex items-center justify-center bg-transparent p-4 sm:p-0">
      ...
      >
        ...
        {/* Title */}
        <h1 className="text-center text-2xl sm:text-3xl font-semibold text-[#5863B2] mb-6 sm:mb-8 shrink-0 flex items-center justify-center gap-2 pr-8">
          Set Attendance
        ...
        <div className="flex flex-col gap-5 sm:gap-7 w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
            <label className="text-[#5863B2] text-base sm:text-xl font-bold w-full sm:w-[40%] text-left">
              Working Hours
            </label>
            ...
            <input
              ...
              disabled={saving}
              className="p-3 sm:p-2 rounded-[10px] border-2 border-[#5764B3]/40 bg-[#ECEEF8] outline-none w-full sm:w-[210px] md:w-[250px] text-[#5764B3] font-semibold text-base placeholder:text-[#5764B3] placeholder:font-semibold disabled:opacity-60"
            />
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
            ...
            <div className="w-full sm:w-[210px] md:w-[250px]">
              <div className="grid grid-cols-4 sm:grid-cols-7 gap-2 sm:gap-1">
                {days.map((day) => (
                  <button
                    ...
                    disabled={saving}
                    className={`text-center py-2 rounded-md border border-[#C9CAE5] shadow-sm text-[11px] sm:text-[10px] font-medium transition-all disabled:opacity-60 ${
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
            ...
            <input
              ...
              disabled={saving}
              className="p-3 sm:p-2 rounded-[10px] border-2 border-[#5764B3]/40 bg-[#ECEEF8] outline-none w-full sm:w-[210px] md:w-[250px] text-[#5764B3] font-semibold text-base disabled:opacity-60"
            />
          </div>
        ...
        <button
          ...
          disabled={saving}
          className={`mt-8 sm:mt-14 w-full sm:w-[300px] mx-auto text-white text-lg sm:text-xl font-bold p-3 sm:p-4 rounded-xl shadow hover:opacity-90 transition-opacity ${
            saving
